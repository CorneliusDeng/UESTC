...
class My_TCP_Server : public TCP_Server<My_TCP_Server>
{
    public:
        My_TCP_Server(int nServerPort, int nLengthOfQueueOfListen = 100, const char *strBoundIP = NULL) : TCP_Server<My_TCP_Server>(nServerPort, nLengthOfQueueOfListen, strBoundIP)
        {
        }
